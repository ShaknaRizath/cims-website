...
const OLD_SITE_BRAND = {
  ...
  aboutSummary:
    "Ceylon Institute of Management Sciences (CIMS), registered with the Registrar of Companies (RoC) as a Private Limited Company in September 2006 and again re-registered in July 2007 with the Registrar of Companies (RoC) under the Companies Act, incorporated in Parliament Act of 2007 as a Private Limited Company with the registration number PV 61481. CIMS offers UGC-recognized Degree programs and TVEC-approved programs, providing recognized Higher Education and professional qualifications to its students.\n\nOn the 16th day of May 2022, Ceylon Institute of Management Sciences was incorporated under the Registrar of Companies (RoC) with Registration No. PV 0025768 to seek the approval of the Ministry of Education as a non-state Degree awarding institution, with additional Directors and investment from external entities for a large scale project.",
  ourRole:
